...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fancy = new MaterialAlertDialogBuilder(this).setNegativeButton("Close",
        ...
        mAccessibilitySwitch.setOnCheckedChangeListener(
                new SwitchMaterial.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton button, boolean isChecked) {
                        ...
                        if (isChecked && AccessibilityMonitoringService.getInstance() == null)
                            startService(new Intent().setClass(MainActivity.this,
                                    AccessibilityMonitoringService.class));
                    }
                });
        mWindowSwitch.setOnCheckedChangeListener(new SwitchMaterial.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton button, boolean isChecked) {
                if (Build.VERSION.SDK_INT >= 23 && !Settings.canDrawOverlays(MainActivity.this)) {
                    fancy.setTitle("Overlay Permission").setMessage(
        ...
        if (getIntent().getBooleanExtra(EXTRA_FROM_QS_TILE, false)) mWindowSwitch.setChecked(true);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add("GitHub Repo").setIcon(R.drawable.ic_github)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (title.equals("About App")) {
            ...
            if (errorLog.isEmpty()) showToast("No log was found", 0);
            else {
                 ...
                 .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                     ...
                     public void onClick(DialogInterface di, int btn) {
                         ...
                         startActivity(new Intent().setAction(Intent.ACTION_VIEW).setData(
                                 Uri.parse("https://github.com/ratulhasanrahat/Current-Activity")));
                     }
                 }).show();
        } else if (title.equals("Bug Report")) {
            fancy.setTitle("Bug Report").setMessage(
                         "If you found a bug while using this app, please take a screenshot of it if possible. If it's a crash then you can find the crash log in this directory: " + new File(
                                 App.getCrashLogDir(),
                                 "crash.txt").getAbsolutePath() + "\n\nAfter you get all necessary things related to the bug, open an issue in github repo of this app with your bug report details")
                 .setPositiveButton("Create", new DialogInterface.OnClickListener() {
                     @Override
                     public void onClick(DialogInterface di, int btn) {
                         di.dismiss();
                         startActivity(new Intent().setAction(Intent.ACTION_VIEW).setData(Uri.parse(
                                 "https://github.com/ratulhasanrahat/Current-Activity/issues/new")));
                     }
                 }).show();
        }
